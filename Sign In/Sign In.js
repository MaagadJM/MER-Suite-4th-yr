...
function checkLogin() {
	...
	var greenNotification = document.getElementById("GREN");
	var redNotification = document.getElementById("RED");
	var notifContainer = document.querySelector(".notif-container");


	if (username === "name" && password === "word") {

		greenNotification.style.display = "block";
	...
	// Show the notif container
	notifContainer.style.display = "block";

	// Hide the notifications after a few seconds (e.g., 3 seconds)
	setTimeout(function () {
		greenNotification.style.display = "none";
		redNotification.style.display = "none";
		notifContainer.style.display = "none"; // Hide the notif container
	}, 7000);
}
